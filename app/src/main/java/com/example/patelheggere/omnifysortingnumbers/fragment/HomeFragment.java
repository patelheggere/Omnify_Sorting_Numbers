...
public class HomeFragment extends Fragment {
    ...
    private View mView;
    private Button btnGenerate, btnSort;
    ...
    {
        tvNumbers = mView.findViewById(R.id.tvNumbers);
        btnGenerate = mView.findViewById(R.id.btnGenerate);
        btnSort = mView.findViewById(R.id.btnSort);
